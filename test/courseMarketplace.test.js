...
contract("CourseMarketplace", (accounts) => {
	...
	describe("Activate the purchased course", () => {
		it("shoult NOT be able to activate course by NOT contract owner", async () => {
	...
	describe("Transfer Ownership", () => {
		...
		it("should NOT tansfer ownership when contract owner is not sending TX", async () => {
			await catchRevert(
				_contract.transferOwnership(accounts[3], { from: accounts[4] })
			);
		});

		it("should tansfer ownership to 3rd address from accounts", async () => {
		...
		it("should tansfer ownership back to initial contract owner", async () => {
